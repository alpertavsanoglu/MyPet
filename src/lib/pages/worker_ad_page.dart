...
class WorkerAdPageScreen extends StatefulWidget {
  const WorkerAdPageScreen({Key? key}) : super(key: key);

  @override
  State<WorkerAdPageScreen> createState() => _WorkerAdPageScreenState();
}

class _WorkerAdPageScreenState extends State<WorkerAdPageScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text("Çalışan İlanı Oluştur",
                  ...
                  child: Column(
                    children: [
                      _customTextFieldWidget(
                          context, "İsim Soyisim", _nameController),
                      ...
                      _customTextFieldWidgetLong(
                          context, "Deneyim", _experienceController),
                    ],
                  ),
                ),
