...
class PetWalkingJobScreen extends StatefulWidget {
  PetWalkingJobScreen({Key? key}) : super(key: key);

  @override
  State<PetWalkingJobScreen> createState() => _PetWalkingJobScreenState();
}

class _PetWalkingJobScreenState extends State<PetWalkingJobScreen> {
